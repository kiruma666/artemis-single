...
interface IStakingPool {
    ...
    event SequencerUnboundInitialize(uint256 _sequencerId);
    event SequencerUnboundFinalize(uint256 _sequencerId, uint256 _amount);
    ...
    function unlockSequencerInitialize(uint32 _l2Gas) external payable;

    function unlockSequencerFinalize(uint32 _l2Gas) external payable;
    ...
    function withdrawStakingAmountToManager(uint256 _amount) external;
