...
contract MockLockingInfo is ILockingInfo, OwnableUpgradeable {
     ...
     */
    function setRewardPayer(address _payer) external {
        rewardPayer = _payer;
    ...
    function _liquidateReward(
        ...
        // mock bridge to L2
        IERC20(l1Token).safeTransfer(_recipient, _amount);
